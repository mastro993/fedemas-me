...
const Contacts: React.FC = () => {
    ...
    const items: ContactItem[] = [
        ...
        {label: "StackOverflow", color: "#f48024", href: "https://stackoverflow.com/users/5372892/federico-mastrini?tab=profile", icon: RiStackOverflowFill },
    ...
    return (
        <Section>
            <p className="md:text-3xl text-2xl font-bold uppercase font-bold italic">Find me</p>
            <p className="md:text-lg text-base text-gray-400 uppercase font-bold italic">You're really curious, aren't you? 👀</p>
            <div className="flex mt-8 flex-wrap md:gap-4 gap-2">
                {
                    items.map((item) => <ContactLink contact={item} />)
                }
            </div>
        </Section>
    );
